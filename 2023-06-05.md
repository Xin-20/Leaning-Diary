# Today's work
### 1. - [x] Download original LLaMA model
1. - [x] Original LLaMA Model Link: https://github.com/shawwn/llama-dl    
...
### 2. - [x] Check the integrity of original model and the LoRA model, make sure the sha256 is the same as indicated in SHA256.md.
1. Linux: sha256sum filename  

### 3. - [x] Transform the original model as HuggingFace format
1. Transformers, convert_llama_weights_to_hf.py, with protobuf-3.19.0.  

### 4. - [x] Merge the weight of the original model with LoRA weight

### 5. - [x] Delopy the quantized model
llama.cpp delpoyment: https://github.com/ymcui/Chinese-LLaMA-Alpaca/wiki/llama.cpp%E9%87%8F%E5%8C%96%E9%83%A8%E7%BD%B2

### 6. - [x] Test the model in Chinese
